  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 0 900 288" {...props} >
      <path
        ...
        fill={props.lightMode ? "#0984e3" : "#9e7ae9"}
      />
      <path
        ...
        fill={props.lightMode ? "#3391ea" : "#a888ef"}
      />
      <path
        ...
        fill={props.lightMode ? "#4c9ef1" : "#b396f4"}
      />
      <path
        ...
        fill={props.lightMode ? "#60acf8" : "#bda4fa"}
      />
      <path
        ...
        fill={props.lightMode ? "#74b9ff" : "#c8b2ff"}
      />
    </svg>
  )
}
