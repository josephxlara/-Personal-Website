  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" viewBox="0 0 900 288" {...props} >
      <path
        ...
        fill={props.lightMode ? "#ff9834" : "#9e7ae9"}
      />
      <path
        ...
        fill={props.lightMode ? "#ffa54b" : "#a888ef"}
      />
      <path
        ...
        fill={props.lightMode ? "#ffb162" : "#b396f4"}
      />
      <path
        ...
        fill={props.lightMode ? "#ffbd78" : "#bda4fa"}
      />
      <path
        ...
        fill={props.lightMode ? "#ffc88e" : "#c8b2ff"}
      />
    </svg>
  )
}
